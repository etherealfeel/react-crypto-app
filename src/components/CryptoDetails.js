  ...
  return (
    <div className="coin">
      <Col className="coin__details">
        ...
        <Select defaultValue="7d" className="coin__select" placeholder="Select Time Period" onChange={(value) => setTimePeriod(value)}>
          {time.map((date) => (
